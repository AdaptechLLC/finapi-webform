...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://webform-live.finapi.io';
    ...
    {
        $report  = 'PHP SDK (OpenAPIWebForm\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.277.0' . PHP_EOL;
