...
class Profile implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The timestamp when the profile was created
     *
     * @return self
     */
     ...
     * Sets default
     *
     * @param bool|null $default Whether the profile will be used by default for all web forms.<br/>We urge you to set one profile as default. This way, if you do not pass the profile in the API call, we will use the default profile from you for the web forms.
     *
     * @return self
     */
