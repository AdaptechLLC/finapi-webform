...
class Brand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['favicon']) && !preg_match("/data:image\/(ico|png|jpg|jpeg|gif|svg+xml);base64,(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?/", $this->container['favicon'])) {
            $invalidProperties[] = "invalid value for 'favicon', must be conform to the pattern /data:image\/(ico|png|jpg|jpeg|gif|svg+xml);base64,(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?/.";
        }
    ...
    public function setFavicon($favicon)
    {
        ...
        if (!is_null($favicon) && (!preg_match("/data:image\/(ico|png|jpg|jpeg|gif|svg+xml);base64,(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?/", $favicon))) {
            throw new \InvalidArgumentException("invalid value for $favicon when calling Brand., must conform to the pattern /data:image\/(ico|png|jpg|jpeg|gif|svg+xml);base64,(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?/.");
        }
