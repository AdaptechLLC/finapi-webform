...
class WebFormType
{
     ...
     */
    const BANK_CONNECTION_IMPORT = 'BANK_CONNECTION_IMPORT';

    const BANK_CONNECTION_UPDATE = 'BANK_CONNECTION_UPDATE';

    const PAYMENT_WITH_ACCOUNT_ID = 'PAYMENT_WITH_ACCOUNT_ID';

    const STANDALONE_PAYMENT = 'STANDALONE_PAYMENT';

    const DIRECT_DEBIT_WITH_ACCOUNT_ID = 'DIRECT_DEBIT_WITH_ACCOUNT_ID';
