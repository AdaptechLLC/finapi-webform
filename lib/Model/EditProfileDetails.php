...
class EditProfileDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets label
     *
     * @param string|null $label Label to profile.<br/><br/>The label must be unique.
     *
     * @return self
     */
     ...
     * Sets default
     *
     * @param bool|null $default Whether or not the profile will be used by default for all web forms.<br/>We urge you to set one profile as default. This way, if you do not pass the profile in the API call, we will use the default profile from you for the web forms.<br/><br/>There can only be one default profile at one time.
     *
     * @return self
     */
