...
class BankConnectionImportDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $max_days_for_download Defines the limit of how many days of the transaction history will be requested from the bank. This parameter refers to the same parameter of the \"Import a new bank connection\" service in the finAPI Access API.
     *
     * @return self
     */
     ...
     * Sets account_types
     *
     * @param string[]|null $account_types A set of account types that are considered for the import. If no values is given, then all accounts will be imported. This parameter refers to the same parameter of the \"Import a new bank connection\" service in the finAPI Access API.
     *
     * @return self
     */
