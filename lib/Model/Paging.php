...
class Paging implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets per_page
     *
     * @param int|null $per_page Size of the current page
     *
     * @return self
     */
     ...
     * Sets page_count
     *
     * @param int|null $page_count Total number of pages available
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count Total number of resources available
     *
     * @return self
     */
