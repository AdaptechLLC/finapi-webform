...
class PaymentRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBic($bic)
    {
        ...
        if (!is_null($bic) && (!preg_match("/^[A-Z]{6}[2-9A-Z][0-9A-NP-Z](XXX|[0-9A-WYZ]{1}[0-9A-Z]{2})?$/", $bic))) {
            throw new \InvalidArgumentException("invalid value for $bic when calling PaymentRecipient., must conform to the pattern /^[A-Z]{6}[2-9A-Z][0-9A-NP-Z](XXX|[0-9A-WYZ]{1}[0-9A-Z]{2})?$/.");
        }
