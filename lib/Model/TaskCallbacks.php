...
class TaskCallbacks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['finalised'] = $data['finalised'] ?? null;
        $this->container['web_form_required'] = $data['web_form_required'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['finalised']) && !preg_match("/https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/", $this->container['finalised'])) {
            $invalidProperties[] = "invalid value for 'finalised', must be conform to the pattern /https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/.";
        }
        ...
        if (!is_null($this->container['web_form_required']) && !preg_match("/https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/", $this->container['web_form_required'])) {
            $invalidProperties[] = "invalid value for 'web_form_required', must be conform to the pattern /https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/.";
        }
    ...
    public function setFinalised($finalised)
    {
        ...
        if (!is_null($finalised) && (!preg_match("/https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/", $finalised))) {
            throw new \InvalidArgumentException("invalid value for $finalised when calling TaskCallbacks., must conform to the pattern /https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/.");
        }
    ...
    public function setWebFormRequired($web_form_required)
    {
        ...
        if (!is_null($web_form_required) && (!preg_match("/https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/", $web_form_required))) {
            throw new \InvalidArgumentException("invalid value for $web_form_required when calling TaskCallbacks., must conform to the pattern /https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/.");
        }
