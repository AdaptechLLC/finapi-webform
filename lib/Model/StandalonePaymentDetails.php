...
class StandalonePaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['instant_payment'] = $data['instant_payment'] ?? false;
    ...
    public function setRedirectUrl($redirect_url)
    {
        ...
        if (!is_null($redirect_url) && (mb_strlen($redirect_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $redirect_url when calling StandalonePaymentDetails., must be bigger than or equal to 0.');
        }
        if (!is_null($redirect_url) && (!preg_match("/https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/", $redirect_url))) {
            throw new \InvalidArgumentException("invalid value for $redirect_url when calling StandalonePaymentDetails., must conform to the pattern /https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/.");
        }
