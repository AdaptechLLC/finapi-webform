...
class Payload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const ERROR_CODE_UNSUPPORTED_ORDER = 'UNSUPPORTED_ORDER';
     ...
     *
     * @param int|null $bank_connection_id Identifier of the bank connection in the Access API. Initialized as soon as the account import process is started in Access system. Use this ID to gather Bank Connection data from Access end points like, \"<a target=\"_blank\" href=\"https://docs.finapi.io/?product=access#get-/api/v1/bankConnections/-id-\">Get a bank connection</a>\" or \"<a target=\"_blank\" href=\"https://docs.finapi.io/?product=access#get-/api/v1/accounts\">Get and search all accounts</a>\".<br/>This field is mutually exclusive with <code>paymentId</code>.
     *
     * @return self
     */
     ...
     * Sets payment_id
     *
     * @param int|null $payment_id Identifier of the payment in the Access API. Initialized as soon as the payment is created in Access system. Use this ID to get Payment initialization data from the Access end point, \"<a target=\"_blank\" href=\"https://docs.finapi.io/?product=access#get-/api/v1/payments\">Get payments</a>\".<br/>This field is mutually exclusive with <code>bankConnectionId</code>.
     *
     * @return self
     */
